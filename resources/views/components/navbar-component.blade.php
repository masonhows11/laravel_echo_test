  ...
  <div
        ...
        @if (Route::has('login'))
            @auth
                ...
                <form method="post" class="md:inline-block  border-b-2 border-teal-900 md:border-none" action="{{ route('logout') }}">
                    @csrf
                    <button
                        class="block md:inline-block text-teal-900
                     hover:text-teal-500 px-3 py-3  border-teal-900 md:border-none">
                        Logout
                    </button>
                </form>
            @else
